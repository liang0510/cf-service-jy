...
public class TeacherInfo {
    ...
    public void setIncumbency(String incumbency) {
        this.incumbency = incumbency == null ? null : incumbency.trim();
    }
    ...
    public String getYnEnable() {
        return ynEnable;
    }

    public void setYnEnable(String ynEnable) {
        this.ynEnable = ynEnable == null ? null : ynEnable.trim();
    }
    ...
    public String getFunp() {
        return funp;
    }

    public void setFunp(String funp) {
        this.funp = funp == null ? null : funp.trim();
    }
    ...
    public void setOut_key(String out_key) {
        this.out_key = out_key == null ? null : out_key.trim();
    }
